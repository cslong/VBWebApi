...
Namespace Areas.HelpPage.Controllers
    ...
    Public Class HelpController
        ...
        Public Function Index() As Microsoft.AspNetCore.Mvc.ActionResult
            ViewData("DocumentationProvider") = Configuration.Services.GetDocumentationProvider()
            Return View(Configuration.Services.GetApiExplorer().ApiDescriptions)
        End Function

        Public Function Api(apiId As String) As Microsoft.AspNetCore.Mvc.ActionResult
        ...
        Public Function ResourceModel(modelName As String) As Microsoft.AspNetCore.Mvc.ActionResult
